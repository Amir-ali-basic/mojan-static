...
@section('content')
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			<!-- pos-rel start -->
			<section id="up" class="pos-rel js-parallax-bg" style="background-image:url(assets/images/about/about_slider/IMG_8195.jpeg)">
				<!-- bg-overlay -->
			...
			<div id="down" class="pos-rel section-bg-light-2" data-midnight="black">
             ...
             {{-- @foreach ($posts as $post ) --}}
						{{-- <article class="padding-top-40 grid-item-50-50-100 js-isotope-filter-grid-item culture">
								...
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									...
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{$post->category->title}}">{{$post->category->title}}</a>
												...
												<article class="padding-top-40 grid-item-50-50-100 js-isotope-filter-grid-item culture">
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/nikiip.JPG" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
								...
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 1">Model 1</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product3")}}">{{__("msg.product3")}}</a>
									</li>
								</ul>
							</div>
						</article><!-- grid-item end -->
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8195.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
								...
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 2">Model 2</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
								</ul>
							</div>
						</article><!-- grid-item end -->
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8193.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 3">model 3</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8146.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 4">Model 4</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8182.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 5">Model 5</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8168.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 6">Model 6</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8156.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 7">Model 7</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
							...
							<div class="grid-margin-box hover-box pos-rel js-touch-hover-scroll">
								<a href="#" class="d-block pos-rel hidden-box content-bg-dark-1 js-pointer-large js-animsition-link">
									<img class="img-hover-opacity img-hover-scale in" src="/cover/tinified/IMG_8188.jpeg" alt="Post">
									<!-- bg-overlay -->
									<div class="bg-overlay-black"></div>
									<h3 class="pos-abs pos-left-bottom headline-xxxs hover-move-right">{{__("msg.product4")}}</h3>
								</a>
								<ul class="pos-abs pos-left-top list list_row list_margin-30px">
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill js-pointer-small" data-text="Model 8">Model 8</a>
									</li>
									<li class="list__item">
										<a href="#" class="subhead-xxs hover-text-fill tr-delay-01 js-pointer-small" data-text="{{__("msg.product4")}}">{{__("msg.product4")}}</a>
									</li>
