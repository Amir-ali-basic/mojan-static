		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
            ...
            @foreach ($posts as $post )
						<div class="padding-top-60 grid-item-33-50-100 js-isotope-filter-grid-item branding">
							<a  href="{{route('blog.single',$post->id )}}" class="grid-margin-box hover-box js-animsition-link js-pointer-large">
								<div class="anim-img-scale anim-img-scale_hover js-img-scale">
									<img class="anim-img-scale__inner" src="/storage/posts/{{$post->image}}" alt="project">
								</div>
								<div class="margin-top-10 js-scrollanim">
									<span class="hidden-box d-block">
										<span class="subhead-xxs text-color-red anim-slide">{{$post->category->title}}</span>
									</span>
									<h3 class="hidden-box">
										<span class="headline-xxxs text-color-black anim-slide tr-delay-02">{{$post->title}}</span>
									</h3>
								</div>
							</a>
						</div><!-- grid-item end -->
